...
IMAGE_UTILS_NAME=ondewo-survey-client-utils-angular:${ONDEWO_SURVEY_VERSION}
PRETTIER_WRITE?=

CURRENT_RELEASE_NOTES=`cat RELEASE.md \
	| perl -ne 'print if /Release ONDEWO Survey Angular Client ${ONDEWO_SURVEY_VERSION}/../^\*{5}/'`

GH_REPO="https://github.com/ondewo/ondewo-survey-client-angular"
...
release: ## Create Github and NPM Release
	...
	git add README.md
	git add RELEASE.md
	git add ondewo-survey-client-angular.d.ts
	git add ondewo-survey-client-angular.d.ts.map
