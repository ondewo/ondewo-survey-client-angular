...
export declare class FHIRClient {
    ...
    $raw: {
         ...
         * @returns Observable<GrpcEvent<thisProto.SurveyFHIRAnswersResponse>>
         */
        getAllFHIRSurveyAnswers: (requestData: ondewoSurvey005.GetAllSurveyAnswersRequest, requestMetadata?: GrpcMetadata) => Observable<GrpcEvent<thisProto.SurveyFHIRAnswersResponse>>;
    };
     ...
     * @returns Observable<thisProto.SurveyFHIRAnswersResponse>
     */
    getAllFHIRSurveyAnswers(requestData: ondewoSurvey005.GetAllSurveyAnswersRequest, requestMetadata?: GrpcMetadata): Observable<thisProto.SurveyFHIRAnswersResponse>;
